...
public class PortfolioComparisonDialog_ENHANCED extends JDialog {
    private App app;
    ...
    public PortfolioComparisonDialog_ENHANCED(App app, DatabaseManager dbManager) {
        super(app, "Portfolio Comparison Enhanced", true);
        this.app = app;
    ...
    private void initializeUI() {
        ...
        // Title
        add(new JLabel("Compare Multiple Portfolios - Enhanced", SwingConstants.CENTER), BorderLayout.NORTH);
        ...
        JPanel aiInsightsPanel = new JPanel(new BorderLayout());
        JTextArea aiInsightsArea = new JTextArea();
        aiInsightsArea.setEditable(false);
        JScrollPane aiScrollPane = new JScrollPane(aiInsightsArea);
        aiInsightsPanel.add(aiScrollPane, BorderLayout.CENTER);
        ...
        compareButton.addActionListener(e -> updateComparison(aiInsightsArea));
    ...
    private void initializeOverviewTab(JPanel panel) {
        ...
        selectionScroll.setPreferredSize(new java.awt.Dimension(350, 250));
    ...
    private void updateComparison(JTextArea aiInsightsArea) {
        ...
        try {
            ...
            // Update AI Insights tab if textarea provided
            if (aiInsightsArea != null) {
                StringBuilder insights = new StringBuilder();
                for (Portfolio portfolio : selectedPortfolios) {
                    insights.append("Portfolio: ").append(portfolio.getName()).append("\n");
                    ...
                    if (!positions.isEmpty()) {
                        ...
                        Map<String, Object> analysis = aiAnalytics.analyzePortfolio(portfolio, positions);
                        insights.append("Risk Level: ").append(analysis.get("riskLevel")).append("\n");
                        insights.append("Recommendations:\n");
                        @SuppressWarnings("unchecked")
                        List<String> recommendations = (List<String>) analysis.get("recommendations");
                        for (String rec : recommendations) {
                            insights.append(" - ").append(rec).append("\n");
                        }
                        insights.append("\n");
                    }
                }
